...
set output 'Comparaison entre code initial et optimisé GCC.jpg'
...
set title 'Comparaison entre les perf du code initial et optimisé (GCC)'

#tracer les histogrammes en utilisant les données de la deuxième colonne des fichiers.dat

plot 'gcc_-Ofast.dat' using 2:xtic(2) ti "-Ofast" lc rgb '#ADD8E6 ','gcc_-O0.dat' using 2:xtic(2) ti "-O0" lc rgb '#6A5ACD', 'gcc_-O1.dat' using 2:xtic(2) ti "-O1" lc rgb '#4169E1', 'gcc_-O2.dat' using 2:xtic(2) ti "-O2" lc rgb '#00008B', 'gcc_-O3.dat' using 2:xtic(2) ti "-O3" lc rgb '#708090', 'gcc_-Og.dat' using 2:xtic(2) ti "-Og" lc rgb '#00688B','optim_gcc_-Ofast.dat' using 2:xtic(2) ti "-Ofast optim" lc rgb '#FFFF00','optim_gcc_-O0.dat' using 2:xtic(2) ti "-O0 optoim" lc rgb  '#F7DC6F', 'optim_gcc_-O1.dat' using 2:xtic(2) ti "-O1 optim" lc rgb '#F4D03F', 'optim_gcc_-O2.dat' using 2:xtic(2) ti "-O2 optim" lc rgb '#D4AC0D ', 'optim_gcc_-O3.dat' using 2:xtic(2) ti "-O3 optim" lc rgb '#9A7D0A' , 'optim_gcc_-Og.dat' using 2:xtic(2) ti "-Og optim" lc rgb '#FFA500 '
