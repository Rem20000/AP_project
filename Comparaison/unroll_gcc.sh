...
set output 'Comparaison entre code initial et déroulé GCC.jpg'
...
set title 'Comparaison entre les perf du code initial et déroulé (GCC)'
...
plot 'gcc_-Ofast.dat' using 2:xtic(2) ti "-Ofast" lc rgb '#ADD8E6 ','gcc_-O0.dat' using 2:xtic(2) ti "-O0" lc rgb '#6A5ACD', 'gcc_-O1.dat' using 2:xtic(2) ti "-O1" lc rgb '#4169E1', 'gcc_-O2.dat' using 2:xtic(2) ti "-O2" lc rgb '#00008B', 'gcc_-O3.dat' using 2:xtic(2) ti "-O3" lc rgb '#708090', 'gcc_-Og.dat' using 2:xtic(2) ti "-Og" lc rgb '#00688B', 'unroll_gcc_-Ofast.dat' using 2:xtic(2) ti "unroll_ -Ofast" lc rgb '#FFFF00','unroll_gcc_-O0.dat' using 2:xtic(2) ti "unroll -O0" lc rgb  '#F7DC6F', 'unroll_gcc_-O1.dat' using 2:xtic(2) ti "unroll -O1" lc rgb '#F4D03F', 'unroll_gcc_-O2.dat' using 2:xtic(2) ti "unroll -O2" lc rgb '#D4AC0D ', 'unroll_gcc_-O3.dat' using 2:xtic(2) ti "unroll -O3" lc rgb '#9A7D0A' , 'unroll_gcc_-Og.dat' using 2:xtic(2) ti "unroll -Og" lc rgb '#FFA500 '
